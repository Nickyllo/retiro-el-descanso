      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {plans.map((plan, index) => (
            ...
            >
              {plan.highlighted && (
                <div className="absolute top-2 left-1/2 -translate-x-1/2 bg-gradient-to-r from-primary to-secondary text-background px-6 py-2 rounded-full text-sm font-bold shadow-lg z-20">
                  Más Popular
                </div>
              )}
